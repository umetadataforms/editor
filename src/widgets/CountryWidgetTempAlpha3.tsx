// FIXME: This is a quick solution for the Alpha-3 codes. Combine Alpha-2 and
// Alpha-3 widgets.
...
const COUNTRIES_FILE = 'data/iso-3166-country-name-and-code-list-alpha-3.json';
...
export default function CountryWidgetTempAlpha3(props: WidgetProps) {
  const {
    id,
    value,
    onChange,
