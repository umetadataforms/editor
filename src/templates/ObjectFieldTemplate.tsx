 ...
 * @license Apache-2.
 *
 * Based on: @rjsf/antd ObjectFieldTemplate (v5.24.12)
 * Source repository: https://github.com/rjsf-team/react-jsonschema-form.git
 * Source file: packages/antd/src/templates/ObjectFieldTemplate.tsx
...
>(props: ObjectFieldTemplateProps<T, S, F>) {
  ...
  const xObjectDescriptionDisplay = (uiOptions as any)?.xObjectDescriptionDisplay;
  ...
  return (
    <>
      ...
      {(xObjectDescriptionDisplay && description) && (
